...
Preview, validate, lease, execute reversible units, stop on drift, test, record sanitized evidence, release, and route to review. Offline, application compatibility, restart, resource coexistence, and removal tests pass.

## 11. Automated acceptance tests

Offline, application compatibility, restart, resource coexistence, and removal tests pass. Applicable schema, scope, secret, link, static, idempotency, rollback, and dependency checks pass; justified exclusions are recorded.
