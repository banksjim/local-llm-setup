...
Preview, validate, lease, execute reversible units, stop on drift, test, record sanitized evidence, release, and route to review. Cloud and approved local tests pass; prohibited models are absent; settings restore works.

## 11. Automated acceptance tests

Cloud and approved local tests pass; prohibited models are absent; settings restore works. Applicable schema, scope, secret, link, static, idempotency, rollback, and dependency checks pass; justified exclusions are recorded.
