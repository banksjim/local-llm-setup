...
Preview, validate, lease, execute reversible units, stop on drift, test, record sanitized evidence, release, and route to review. A fixed corpus produces a selected embedding model and versioned threshold.

## 11. Automated acceptance tests

A fixed corpus produces a selected embedding model and versioned threshold. Applicable schema, scope, secret, link, static, idempotency, rollback, and dependency checks pass; justified exclusions are recorded.
