...
Preview, validate, lease, execute reversible units, stop on drift, test, record sanitized evidence, release, and route to review. The owner can start, stop, inspect, and identify persistent data without learning Kubernetes.

## 11. Automated acceptance tests

The owner can start, stop, inspect, and identify persistent data without learning Kubernetes. Applicable schema, scope, secret, link, static, idempotency, rollback, and dependency checks pass; justified exclusions are recorded.
