...
Preview, validate, lease, execute reversible units, stop on drift, test, record sanitized evidence, release, and route to review. A synthetic trace appears, persists, and restores; private payload defaults are documented.

## 11. Automated acceptance tests

A synthetic trace appears, persists, and restores; private payload defaults are documented. Applicable schema, scope, secret, link, static, idempotency, rollback, and dependency checks pass; justified exclusions are recorded.
