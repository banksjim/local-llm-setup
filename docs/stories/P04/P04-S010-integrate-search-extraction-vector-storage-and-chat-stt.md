# P04-S010: Integrate search, extraction, vector storage, and chat STT
...
As the workstation owner, I want this story to wire SearXNG, Docling, PGVector, and Open WebUI local in-chat transcription with bounded resources, so that progress is inspectable and independent of chat memory.

## 2. Bounded objective

Wire SearXNG, Docling, PGVector, and Open WebUI local in-chat transcription with bounded resources.
...
Preview, validate, lease, execute reversible units, stop on drift, test, record sanitized evidence, release, and route to review. Known-answer tests prove each route and distinguish in-chat STT from desktop dictation.

## 11. Automated acceptance tests

Known-answer tests prove each route and distinguish in-chat STT from desktop dictation. Applicable schema, scope, secret, link, static, idempotency, rollback, and dependency checks pass; justified exclusions are recorded.
