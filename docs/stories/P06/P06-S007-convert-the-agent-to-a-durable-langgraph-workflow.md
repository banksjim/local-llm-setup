...
Preview, validate, lease, execute reversible units, stop on drift, test, record sanitized evidence, release, and review. Tests cover resume, duplicate invoke, tool failure, approval denial, and state migration.

## 11. Automated acceptance tests

Tests cover resume, duplicate invoke, tool failure, approval denial, and state migration. Applicable schema, scope, secret, link, static, idempotency, rollback, and dependency checks pass; exclusions are justified.
