...
| Research freshness | Not applicable — behavior is defined by SYS-RAG. |

## 1. User story

As the workstation owner, I want this story to preserve changed originals, update stable Markdown through Git history, mark missing sources, and require deletion approval, so progress is inspectable and independent of chat memory.

## 2. Bounded objective

Preserve changed originals, update stable Markdown through Git history, mark missing sources, and require deletion approval.
...
P07-S011. Applicable specs, clean Git, valid controller state, current research, route, and lease checks pass.
...
Preview, validate, lease, execute reversible units, stop on drift, test, record sanitized evidence, release, and review. Change, duplicate, missing, restore, and denied-delete fixtures pass.

## 11. Automated acceptance tests

Change, duplicate, missing, restore, and denied-delete fixtures pass. Applicable schema, scope, secret, link, static, idempotency, rollback, and dependency checks pass; exclusions are justified.
