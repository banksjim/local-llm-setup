...
The active Windows program contains 129 sequenced stories. Every story follows the [canonical contract](../specifications/standards/STORY-CONTRACT.md), including explicit research, learning, scope, risk, approval, tests, evidence, rollback, and pause boundaries.
...
| P04 | 11 | [Open WebUI and services](../specifications/phases/P04-open-webui-and-supporting-ai-services.md) |
